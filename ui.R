                    ...
                    mainPanel(
                        ...
                        tabsetPanel(type = "tabs",
                                    tabPanel("Modeling Info", 
                                             ...
                                             h3("Probability"),
                                             p("If the probability of being in a certain class is desired, either the Gini Index or Deviance should be used."),
                                             withMathJax(helpText("Gini Index $$G=\\sum_{k=1}^K\ \\hat{p}_{mk}\ (1 - \\hat{p}_{mk})$$")),
                                             withMathJax(helpText("Deviance $$D=-\\sum_{k=1}^K\ \\hat{p}_{mk}\ log(\\hat{p}_{mk})$$")),
                                             h3("Drawbacks"),
